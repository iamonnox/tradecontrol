...
I formally separated out what I call the [_jacere_](tc_functions.md#organisations) (object, subject and project) and gave them friendly names (activities, organisations and tasks). The unfamiliar name-spacing function was completely removed from the schema. Instead component structure was modelled by a more traditional workflow design. Once references to manufacturing production had been expunged, I added the financial dimension using the [cash polarity principle](tc_functions.md#cash-polarity) I had implemented in The Cash 2002.
