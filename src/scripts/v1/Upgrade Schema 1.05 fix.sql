if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[vwStatementVat]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[vwStatementVat]
GO
...
CREATE VIEW dbo.vwStatementCorpTax
WITH ENCRYPTION AS
